...
class ExpressionEditor {
  ...
  didMount() {
    ...
    this._commands = atom.commands.add(this.editor.element, {
      ...
      "jupyter-repl:data-explorer-focus-toolbar": () => this.props.onFocusToolbar?.(),
      "jupyter-repl:data-explorer-focus-body": () => this.props.onFocusBody?.(),
    });
  }
...
class DataExplorer {
  ...
  didMount() {
    ...
    this._toolbarCommands = atom.commands.add(this.refs.toolbar, {
      ...
      "jupyter-repl:data-explorer-focus-expression": () => this.focusExpression(),
      "jupyter-repl:data-explorer-focus-body": () => this.focusBody(),
    });
  }

...
class CanvasGrid {
  ...
  didMount() {
    ...
    this._commands = atom.commands.add(this.refs.wrap, {
      ...
      "jupyter-repl:data-grid-page-up": page(-1),
      "jupyter-repl:data-grid-page-down": page(1),
      "jupyter-repl:data-grid-select-page-up": page(-1, true),
      "jupyter-repl:data-grid-select-page-down": page(1, true),
      "jupyter-repl:data-grid-move-to-row-start": moveTo(null, 0),
      "jupyter-repl:data-grid-move-to-row-end": command(() => {
        const { nCols } = this.gridSize();
        this.moveActiveSelectionTo(null, nCols - 1);
      }),
      "jupyter-repl:data-grid-select-to-row-start": moveTo(null, 0, true),
      "jupyter-repl:data-grid-select-to-row-end": command(() => {
        const { nCols } = this.gridSize();
        this.moveActiveSelectionTo(null, nCols - 1, true);
      }),
      "jupyter-repl:data-grid-select-row": command(() => this.selectActiveRow()),
      "jupyter-repl:data-grid-select-column": command(() => this.selectActiveColumn()),

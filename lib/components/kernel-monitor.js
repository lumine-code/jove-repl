  ...
  componentDidMount() {
    ...
    this.disposables.add(
      atom.commands.add(this.rootRef.current, {
        "hydrogen:kernel-monitor-up": () => this.move(-1),
        "hydrogen:kernel-monitor-down": () => this.move(1),
        "hydrogen:kernel-monitor-open": () => this.openFiles(),
        "hydrogen:kernel-monitor-interrupt": () => this.act(interrupt),
        "hydrogen:kernel-monitor-restart": () => this.act(restart),
        "hydrogen:kernel-monitor-shutdown": () => this.act(shutdown),
      }),

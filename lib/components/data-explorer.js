...
class ExpressionEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    this._commands = atom.commands.add(this.editor.element, {
      ...
      "hydrogen:data-explorer-focus-toolbar": () => this.props.onFocusToolbar?.(),
      "hydrogen:data-explorer-focus-body": () => this.props.onFocusBody?.(),
    });
  }
...
class DataExplorer extends React.Component {
  ...
  componentDidMount() {
    ...
    this._bodyCommands = atom.commands.add(this.bodyRef.current, {
      "hydrogen:data-explorer-focus-expression": () => this.focusExpression(),
      "hydrogen:data-explorer-focus-toolbar": () => this.focusToolbar(),
      "hydrogen:data-explorer-drill-up": () => this.props.des.drillUp(),
    });
    this._toolbarCommands = atom.commands.add(this.toolbarRef.current, {
      "hydrogen:data-explorer-toolbar-left": (event) => this.focusToolbarItem(event, -1),
      "hydrogen:data-explorer-toolbar-right": (event) => this.focusToolbarItem(event, 1),
      "hydrogen:data-explorer-toolbar-confirm": (event) => this.confirmToolbarItem(event),
      "hydrogen:data-explorer-focus-expression": () => this.focusExpression(),
      "hydrogen:data-explorer-focus-body": () => this.focusBody(),
    });
  }

...
class ExpressionEditor extends React.Component {
  ...
  componentDidMount() {
    ...
    this._commands = atom.commands.add(this.editor.element, {
      ...
      "jove-repl:data-explorer-focus-toolbar": () => this.props.onFocusToolbar?.(),
      "jove-repl:data-explorer-focus-body": () => this.props.onFocusBody?.(),
    });
  }
...
class DataExplorer extends React.Component {
  ...
  componentDidMount() {
    ...
    this._bodyCommands = atom.commands.add(this.bodyRef.current, {
      "jove-repl:data-explorer-focus-expression": () => this.focusExpression(),
      "jove-repl:data-explorer-focus-toolbar": () => this.focusToolbar(),
      "jove-repl:data-explorer-drill-up": () => this.props.des.drillUp(),
    });
    this._toolbarCommands = atom.commands.add(this.toolbarRef.current, {
      "jove-repl:data-explorer-toolbar-left": (event) => this.focusToolbarItem(event, -1),
      "jove-repl:data-explorer-toolbar-right": (event) => this.focusToolbarItem(event, 1),
      "jove-repl:data-explorer-toolbar-confirm": (event) => this.confirmToolbarItem(event),
      "jove-repl:data-explorer-focus-expression": () => this.focusExpression(),
      "jove-repl:data-explorer-focus-body": () => this.focusBody(),
    });
  }

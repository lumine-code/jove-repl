...
export default class InputView {
  constructor({ prompt, defaultText, allowCancel, password }, onConfirmed, onCancelled) {
    ...
    this._textEditorDisposable = atom.textEditors.add(this.miniEditor);
  ...
  close() {
    ...
    // Hand focus back to whatever `attach()` took it from.
  ...
  attach() {
    // Remember where focus came from so `close()` can put it back.

...
/**
 * The Data Explorer lives in its own package now; the Variables panel hands it
 * a name through this rather than reaching into a store it no longer owns.
 * Optional: without it the panel simply offers no link.
 */
function consumeDataExplorer(service) {
  dataExplorerService = service;
  return new Disposable(() => {
    dataExplorerService = null;
  });
}

function getDataExplorerService() {

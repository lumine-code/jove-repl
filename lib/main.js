...
export function activate() {
  ...
  store.subscriptions.add(
    ...
    atom.commands.add("atom-workspace", {
      ...
      "hydrogen-next:open-data-explorer": () => exploreData(),
      "hydrogen-next:debug-toggle": () => debugToggle(),
      "hydrogen-next:toggle-kernel-monitor-focus": () => toggleKernelMonitorFocus(),
      ...
      "hydrogen-next:toggle-inspector-focus": () =>
        require("./commands").showInspector(store, hydrogenAdapterServices),
      "hydrogen-next:inspect-under-cursor": () =>

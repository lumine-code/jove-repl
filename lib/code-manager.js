...
export function getExpressionInfoAtCursor(editor) {
...
export function getExpressionAtCursor(editor) {
...
function applyScrollBehavior(editor) {
  const scrollMode = atom.config.get("jove-repl.scrollOnMoveDown");

 ...
 * other. Jupyter both provides and consumes _services_ to add additional
 ...
 * - [Autocomplete For Any Editor: `autocomplete.watch-editor`](./consumed/autocomplete.js)
 *
 *   - This allows us to add autocomplete to things like watches.
 *
 * ### Provided Services
 *
 * - [Autocomplete Results: `autocomplete.provider`](./provided/autocomplete.js)
 *
 ...
 * [LICENSE.md](https://github.com/nteract/jupyter-repl/blob/master/LICENSE.md) file
 * for details.
 */

module.exports = { consumed, provided };

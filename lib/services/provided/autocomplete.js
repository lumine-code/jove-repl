...
export function provideAutocompleteResults(store) {
  const autocompleteProvider = {
    enabled: atom.config.get("jove-repl.autocomplete"),
    ...
    suggestionPriority: atom.config.get("jove-repl.autocompleteSuggestionPriority"),
    // It won't suppress providers with lower priority.
    excludeLowerPriority: false,
    suggestionDetailsEnabled: atom.config.get("jove-repl.showInspectorResultsInAutocomplete"),
  ...
  store.subscriptions.add(
    atom.config.observe("jove-repl.autocomplete", (v) => {
      autocompleteProvider.enabled = v;
    }),
    atom.config.observe("jove-repl.autocompleteSuggestionPriority", (v) => {
      autocompleteProvider.suggestionPriority = v;
    }),
    atom.config.observe("jove-repl.showInspectorResultsInAutocomplete", (v) => {

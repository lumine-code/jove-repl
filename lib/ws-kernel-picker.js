...
class WSKernelPicker {
  constructor(onChosen) {
    ...
    this.gatewayList = atom.workspace.buildSelectList({
    ...
    this.authList = atom.workspace.buildSelectList({
      className: "jupyter-repl ws-kernel-picker",
      items: AUTH_METHODS,
      filterKeyForItem: (item) => item.name,
      elementForItem: listItem,
    ...
    this.credentialDialog = atom.workspace.buildInputDialog({
      className: "jupyter-repl ws-kernel-picker",
    ...
    this.sessionList = atom.workspace.buildSelectList({
      className: "jupyter-repl ws-kernel-picker",
      items: [],
    ...
    this.specList = atom.workspace.buildSelectList({
      className: "jupyter-repl ws-kernel-picker",
      items: [],

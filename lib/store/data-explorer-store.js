...
import DataExplorerSearchAdapter from "../data-explorer-search";
...
function buildSerializerCode(expression) {
  ...
  return `
def _jupyter-repl_data_explorer():
    import json, math
    MAX_ROWS = 1000
    MAX_COLS = 100
...
print(__import__("json").dumps(_jupyter-repl_data_explorer(), default=str))
del _jupyter-repl_data_explorer
`;
}
...
export class DataExplorerStore {
  ...
  constructor() {
    makeObservable(this, {
      ...
      searchMatches: observable.ref,
      searchCurrentIndex: observable,
      setSearchMatches: action,
      refreshSearchResults: action,
      isPython: computed,

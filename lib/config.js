...
const Config = {
  ...
  schema: {
    ...
    importNotebookURI: {
      ...
      description:
        "If enabled, opening a file with extension `.ipynb` will import the notebook file's source into a new tab. If disabled, or if the hydrogen-next package is not activated, the raw file will open in Lumine as normal.",
      type: "boolean",
      default: true,
    },

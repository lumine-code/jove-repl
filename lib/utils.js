...
export const INSPECTOR_URI = "atom://jove-repl/inspector";

export const WATCHES_URI = "atom://jove-repl/watch-sidebar";

export const OUTPUT_AREA_URI = "atom://jove-repl/output-area";

export const KERNEL_MONITOR_URI = "atom://jove-repl/kernel-monitor";

export const VARIABLE_EXPLORER_URI = "atom://jove-repl/variable-explorer";

export const DATA_EXPLORER_URI = "atom://jove-repl/data-explorer";
...
export function log(...message) {
  if (atom.config.get("jove-repl.debug")) {
    console.log("jove-repl:", ...message);
  }
}

export function hotReloadPackage() {
  const packName = "jove-repl";

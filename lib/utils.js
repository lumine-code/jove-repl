...
export const INSPECTOR_URI = "atom://jupyter-repl/inspector";

export const WATCHES_URI = "atom://jupyter-repl/watch-sidebar";

export const OUTPUT_AREA_URI = "atom://jupyter-repl/output-area";

export const KERNEL_MONITOR_URI = "atom://jupyter-repl/kernel-monitor";

export const VARIABLE_EXPLORER_URI = "atom://jupyter-repl/variable-explorer";

export const DATA_EXPLORER_URI = "atom://jupyter-repl/data-explorer";

...
const WATCHES_URI = "lumine://jupyter-repl/watch-sidebar";

const OUTPUT_AREA_URI = "lumine://jupyter-repl/output-area";

const KERNEL_MONITOR_URI = "lumine://jupyter-repl/kernel-monitor";

const VARIABLE_EXPLORER_URI = "lumine://jupyter-repl/variable-explorer";
 ...
 */
async function openInCenter(URI, options = {}) {
  const pane = atom.workspace.paneForURI(URI);
  if (pane) {
    pane.activateItemForURI(URI);
    pane.activate();

 ...
 *
 * @param {Object} store - Global Jove Store
...
export function createResult({ editor, kernel, markers }, { code, row, cellType }) {
  ...
  const globalOutputStore =
    atom.config.get("jove-repl.outputAreaDefault") ||
 ...
 * allows for jove-repl to display markdown text as if is was any normal result

...
class DataExplorerPane extends BasePane {
  ...
  // The store asks the active pane item which kernel it is showing, rather than
  // knowing this pane by its URI. The data on screen came from one particular
  // kernel, which is not necessarily the last focused editor's.
  getJupyterKernel() {
